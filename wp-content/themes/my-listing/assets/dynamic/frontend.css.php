...
input[type=submit].button-2 { background: <?php echo $brand; ?>; }
.button-3 { color: <?php echo $brand; ?>; border: 2px solid <?php echo $brand; ?>; }
...
.profile-header .profile-menu ul li.active a { border-bottom: 1px solid <?php echo $brand; ?>; }
...
.footer-bottom .social-links ul li a:hover { border-bottom: 1px solid <?php echo $brand; ?>; }
.featured-categories.transparent ul li a:hover { background: <?php echo $brand; ?>; }
...
.bl-tabs .nav-tabs>li.active>a, .finder-tabs .nav-tabs>li.active>a:focus, .finder-tabs .nav-tabs>li.active>a:hover { border-bottom: 2px solid <?php echo $brand; ?>; color: <?php echo $brand; ?>; }
...
.finder-tabs .nav-tabs>li.active>a:hover { border-bottom: 2px solid <?php echo $brand; ?>; color: <?php echo $brand; ?>; }
...
.profile-menu #border-bottom { border-bottom: 1px solid <?php echo $brand; ?>; }
.listing-form-heading { border-bottom: 1px solid <?php echo $brand; ?>; }
...
.select2-container--default.select2-container--focus .select2-selection--multiple { border-bottom: 2px solid <?php echo $brand; ?>; }
.daterangepicker td.active,
.daterangepicker td.active:hover { background: <?php echo $brand; ?>; }
.daterangepicker .input-mini.active { border-bottom: 1px solid <?php echo $brand; ?>; }
.select2-container--default .select2-search--dropdown .select2-search__field { border-bottom: 1px solid <?php echo $brand; ?>; }

/* tmp.css */
.job_listing_preview .wpcf7 input[type="submit"].wpcf7-form-control,
.wpcf7-form input[type="submit"] { background: <?php echo $brand; ?>; }
.c27-pick-package.c27-picked { border: 1px solid <?php echo $brand; ?>; }
...
.woocommerce div.product .woocommerce-tabs ul.tabs li.active a { border-bottom: 2px solid <?php echo $brand; ?>; color: <?php echo $brand; ?>; }
...
#buddypress div#item-nav div.item-list-tabs ul li.selected a {
  border-bottom: 1px solid <?php echo $brand; ?>;
}
...
form.standard-form .bp-avatar-nav .avatar-nav-items li.avatar-nav-item.current a {
  border-bottom: 1px solid <?php echo $brand; ?>;
  color: <?php echo $brand; ?>;
}
form.standard-form .bp-avatar-nav .avatar-nav-items li.avatar-nav-item a:hover {
  border-bottom: 1px solid <?php echo $brand; ?>;
  color: <?php echo $brand; ?>;
}
