...
<div class="listing-quick-view-container listing-preview <?php echo esc_attr( "quick-view-{$quick_view_template}" ) ?>">
	<div class="mc-left">
					...
					<div class="listing-details">
						<ul>
							<?php foreach ($categories as $category):?>
								<li>
									<a href="<?php echo esc_url( get_term_link( $category, 'job_listing_category' ) ) ?>">
										<span class="cat-icon" style="background-color: <?php echo esc_attr( get_field( 'color', 'job_listing_category_' . $category->term_id ) ) ?>;">
											<i class="<?php echo esc_attr( get_field( 'icon', 'job_listing_category_' . $category->term_id ) ) ?>"
												style="color: <?php echo esc_attr( get_field( 'text_color', 'job_listing_category_' . $category->term_id ) ) ?>"></i>
										</span>
