                    ...
                    <?php if (!is_wp_error($categories) && count($categories)):
                        ...
                        <li>
                            <a href="<?php echo esc_url( get_term_link( $first_category ) ) ?>">
                                <span class="cat-icon" style="background-color: <?php echo esc_attr( get_field('color', 'category_' . $first_category->term_id) ? : c27()->defaults()['category']['color'] ) ?>;">
                                    <i class="<?php echo esc_attr( get_field('icon', 'category_' . $first_category->term_id) ? : c27()->defaults()['category']['icon'] ) ?>"
                                        style="color: <?php echo esc_attr( get_field('text_color', 'category_' . $first_category->term_id) ? : c27()->defaults()['category']['text_color'] ) ?>">
                                    </i>
                                </span>
