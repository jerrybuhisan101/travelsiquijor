...
class CASE27_Assets {
	...
	public function enqueue_scripts()
	{
		...
		// URL Scripts.
		wp_enqueue_script('c27-google-maps', 'https://maps.googleapis.com/maps/api/js?key=' . c27()->get_setting('general_google_maps_api_key') . '&libraries=places', array(), CASE27_THEME_VERSION, true);
		...
		if (CASE27_ENV === 'dev') {
			...
			wp_enqueue_script('c27-main', c27()->template_uri("assets/dist/scripts/frontend.min.js"), ['jquery'], CASE27_THEME_VERSION, true);
	...
	public function enqueue_icons()
	{
		if (CASE27_ENV === 'dev') {
			...
			wp_enqueue_style('c27-icons', c27()->template_uri('assets/dist/styles/icons.min.css'), [], CASE27_THEME_VERSION);
		}
	}
	...
	public function enqueue_styles()
	{
		...
		if (CASE27_ENV === 'dev') {
			...
			wp_enqueue_style( 'c27-style', c27()->template_uri('assets/dist/styles/frontend.min.css'), [], CASE27_THEME_VERSION );
