<?php
$data = [
	'listing_types' => get_posts(['numberposts' => -1, 'post_type' => 'case27_listing_type']),
];

?>

<script type="text/javascript">
	var CASE27_Listing_Type_Options__Layout_Blocks = <?php echo json_encode( CASE27\Integrations\ListingTypes\Designer::profile_layout_blocks() ) ?>;
</script>
