...
<a href="<?php echo esc_url( wc_get_account_endpoint_url('27-add-product') ) ?>" class="buttons button-5 button-animated pull-right">
				...
				<tr>
					...
					<td class="product-title">
						...
						<ul class="job-dashboard-actions">
							<li><a href="<?php echo esc_url( add_query_arg( 'product_id', get_the_ID(), wc_get_account_endpoint_url('27-add-product') ) ) ?>">Edit</a></li>
						</ul>
					</td>
