					...
					<?php foreach ( $user_packages as $key => $package ) :
						...
						<li class="user-job-package">
							...
							if ( $package->get_limit() ) {
								printf( _n( '%s job posted out of %d', '%s jobs posted out of %d', $package->get_count(), 'my-listing' ), $package->get_count(), $package->get_limit() );
							} else {
								printf( _n( '%s job posted', '%s jobs posted', $package->get_count(), 'my-listing' ), $package->get_count() );
							}
