<div class="job-manager-uploaded-file">
	...
	<?php else : ?>
		<span class="job-manager-uploaded-file-name"><code><?php echo esc_html( basename( $image_src ) ); ?></code> <a class="job-manager-remove-uploaded-file" href="#"><i class="material-icons">delete</i></a></span>
	<?php endif; ?>
