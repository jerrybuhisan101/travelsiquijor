...
class CASE27_Admin {
	...
	public function __construct()
	{
        ...
        add_action('admin_init', function() {
            add_editor_style('assets/dist/styles/editor.min.css');
        });
	}
    ...
    public function enqueue_scripts()
    {
        ...
        if (CASE27_ENV === 'dev') {
            ...
            wp_enqueue_style( 'theme-style-general', c27()->template_uri('assets/dist/styles/admin.min.css'), [], CASE27_THEME_VERSION );
            wp_enqueue_script( 'theme-script-main', c27()->template_uri('assets/dist/scripts/admin.min.js'), ['jquery'], CASE27_THEME_VERSION, true );
        }
    ...
    public function admin_menu()
    {
        ...
        c27()->new_admin_page(
            ...
            [
                'case27/tools.php',
                __( 'Import Demo', 'my-listing' ),
                __( 'Import Demo', 'my-listing' ),
                'manage_options',
                'case27-tools-setup',
                function() {
                    require_once CASE27_THEME_DIR . '/includes/setup/templates/choose-demo.php';
                },
            ]
        );
    ...
    public function reorder_admin_menu()
    {
        ...
        $submenu['case27/tools.php'] = array_filter([
            isset($submenu['case27/tools.php'][4]) ? $submenu['case27/tools.php'][4] : null,
