...
class CASE27_Search_Form_Shortcode {
	...
	public function output_options()
	{
		...
		?>
			...
			<div class="form-group">
				<label><?php _e( 'Tab Style', 'my-listing' ) ?></label>
				<select v-model="shortcode.attributes.tabs_mode">
					<option value="light"><?php _e( 'Light', 'my-listing' ) ?></option>
					<option value="dark"><?php _e( 'Dark', 'my-listing' ) ?></option>
				</select>
			</div>
...
return new CASE27_Search_Form_Shortcode;